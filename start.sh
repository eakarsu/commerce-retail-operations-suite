...
PORT="${PORT:-4000}"
DB_NAME="${PGDATABASE:-commerce_retail_operations_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Commerce Retail Operations Suite"
echo "======================================="
echo
...
echo "Starting commerce retail operations suite frontend on http://localhost:$PORT"
echo "Login: admin@commerce-retail.local / admin123"
