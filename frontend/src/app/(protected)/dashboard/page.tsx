...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="Commerce Retail Operations Dashboard"
      subtitle="One merged commerce retail operations view for Orders, Customers, Catalog, Inventory, Pricing, documents, audit, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared commerce retail operations jobs into one surface. Orders, Customers, Catalog, Inventory, Pricing, Promotions, documents, audit, and AI are presented as platform features.</div>
