export const AUTH_COOKIE = 'commerce_retail_operations_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@commerce-retail.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@commerce-retail.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@commerce-retail.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
